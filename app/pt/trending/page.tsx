...
export const metadata: Metadata = {
  title: "Botões de Som em Alta | Meme Soundboard Popular",
  description: "Descubra os botões de som em alta, meme soundboard viral e efeitos sonoros no Myinstants. Reproduza, baixe e compartilhe para memes, games e entretenimento!",
  metadataBase: new URL(SITE.baseUrl),
  alternates: {
    canonical: `${SITE.baseUrl}/pt/trending`,
    languages: {
...
export default async function PortugueseTrendingPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Botões de Som em Alta", "item": `${SITE.baseUrl}/pt/trending` },
    ],
  }
  ...
  const collectionSchema = {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    "name": "Botões de Som em Alta",
    "description": "Descubra os botões de som mais populares e em alta agora mesmo.",
    "url": `${SITE.baseUrl}/pt/trending`,
    "inLanguage": "pt",
    "mainEntity": {
      "@type": "ItemList",
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-6">
          <h1 className="flex items-center gap-2 text-2xl font-bold text-slate-900 dark:text-white md:text-3xl">
            ...
            Botões de Som em Alta
          </h1>
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            Descubra os botões de som mais populares e em alta agora mesmo.
          </p>
          {count > 0 && (
        ...
        {sounds.length > 0 ? (
          ...
          <div className="py-16 text-center">
            <p className="text-slate-500 dark:text-slate-400">Nenhum botão em alta no momento.</p>
          </div>
        )}
      </main>
      <Footer />
