...
export const metadata: Metadata = {
  title: "Trending Sound Buttons: Most Popular Meme Soundboard",
  description: "Discover the most popular trending sound buttons, viral meme soundboard and sound effects on Myinstants! Play, download and share sound effects for memes, gaming, entertainment!",
  alternates: {
    canonical: `${SITE.baseUrl}/trending`,
    languages: { en: `${SITE.baseUrl}/trending`, es: `${SITE.baseUrl}/es/trending`, fr: `${SITE.baseUrl}/fr/trending`, pt: `${SITE.baseUrl}/pt/trending`, ru: `${SITE.baseUrl}/ru/trending` },
  },
  openGraph: {
    title: "Trending Sound Buttons: Most Popular Meme Soundboard",
    description: "Discover the most popular trending sound buttons, viral meme soundboard and sound effects on Myinstants! Play, download and share sound effects for memes, gaming, entertainment!",
    url: `${SITE.baseUrl}/trending`,
...
export default async function TrendingPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Trending Sounds", "item": `${SITE.baseUrl}/trending` }
    ]
  };
  ...
  const collectionSchema = {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    "name": "Trending Sound Buttons: Most Popular Meme Soundboard",
    "description": "Discover the most popular and trending sound buttons right now",
    "url": `${SITE.baseUrl}/trending`,
    "mainEntity": {
      "@type": "ItemList",
      "numberOfItems": count,
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-6">
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            Discover the most popular and trending sound buttons right now
          </p>
          {count > 0 && (
