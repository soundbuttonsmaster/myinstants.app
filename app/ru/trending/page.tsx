...
export const metadata: Metadata = {
  title: "Трендовые Звуковые Кнопки | Популярный Мем Саундборд",
  description: "Откройте трендовые звуковые кнопки, вирусный мем саундборд и эффекты на Myinstants. Воспроизводите, скачивайте и делитесь для мемов, гейминга и развлечений!",
  metadataBase: new URL(SITE.baseUrl),
  alternates: {
    canonical: `${SITE.baseUrl}/ru/trending`,
    languages: {
      en: `${SITE.baseUrl}/trending`,
      es: `${SITE.baseUrl}/es/trending`,
      fr: `${SITE.baseUrl}/fr/trending`,
      pt: `${SITE.baseUrl}/pt/trending`,
      ru: `${SITE.baseUrl}/ru/trending`,
    },
  },
  openGraph: {
    locale: "ru_RU",
    url: `${SITE.baseUrl}/ru/trending`,
    title: "Трендовые Звуковые Кнопки | Популярный Мем Саундборд",
    description: "Откройте трендовые звуковые кнопки, вирусный мем саундборд и эффекты на Myinstants. Воспроизводите, скачивайте и делитесь для мемов, гейминга и развлечений!",
...
export default async function RussianTrendingPage() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Трендовые Звуковые Кнопки", "item": `${SITE.baseUrl}/ru/trending` },
    ],
  }
  ...
  const collectionSchema = {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    "name": "Трендовые Звуковые Кнопки",
    "description": "Откройте самые популярные и трендовые звуковые кнопки прямо сейчас.",
    "url": `${SITE.baseUrl}/ru/trending`,
    "inLanguage": "ru",
    "mainEntity": {
      "@type": "ItemList",
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-6">
          <h1 className="flex items-center gap-2 text-2xl font-bold text-slate-900 dark:text-white md:text-3xl">
            ...
            Трендовые Звуковые Кнопки
          </h1>
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            Откройте самые популярные и трендовые звуковые кнопки прямо сейчас.
          </p>
          {count > 0 && (
        ...
        {sounds.length > 0 ? (
          ...
          <div className="py-16 text-center">
            <p className="text-slate-500 dark:text-slate-400">Нет трендовых кнопок в данный момент.</p>
          </div>
        )}
      </main>
      <Footer />
