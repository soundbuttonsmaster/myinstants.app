...
## Site: MemeSoundboard.Org

**Domain:** memesoundboard.org

**Base URL:** https://memesoundboard.org

**Description:** memesoundboard is $1 at Meme Soundboard And Soundboard
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds

### POST http://play.soundboard.cloud/api/memesoundboard.org/sounds
...
```json
{
  ...
  "data": {
    "count": 100,
    "next": "http://play.soundboard.cloud/api/memesoundboard.org/sounds?page=2",
    "previous": null,
    "results": [
      {
        "id": 1,
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds?category={category_id}
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/search
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/user/favorites
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/user/likes
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/user/uploaded
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}/related
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}/audio
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}/like

### DELETE http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}/like
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}/favorite

### DELETE http://play.soundboard.cloud/api/memesoundboard.org/sounds/{id}/favorite
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/new
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/sounds/trending
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/sounds/views
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/user/register
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/user/login
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/user/profile

### POST http://play.soundboard.cloud/api/memesoundboard.org/user/profile
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/user/forgot-password
...
### POST http://play.soundboard.cloud/api/memesoundboard.org/user/reset-password
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/user/categories
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/user/categories/{id}
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/user/blogs
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/user/blogs/{id}
...
### GET http://play.soundboard.cloud/api/memesoundboard.org/user/blogs/{id}/image
